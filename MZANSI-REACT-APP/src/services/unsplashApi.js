// Unsplash API service for fetching real product images
// You'll need to get an API key from https://unsplash.com/developers
...
export const getOptimizedImageUrl = (baseUrl, width = 400, height = 300, quality = 80) => {
  ...
  // If it's already an Unsplash URL, add parameters
